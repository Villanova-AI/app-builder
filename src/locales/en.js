export default {
  ...
  messages: {
    ...
    'app.welcome': 'Welcome to Villanova, {name}!',
    'app.yes': 'Yes',
    'app.no': 'No',
    'app.add': 'Add',
    'app.edit': 'Edit',
    ...
    'pages.pageForm.mimeTypeHelp': 'Identifies the type of information (imagine, text..) that Villanova gives back to the requesting browser.',
    ...
    'pageSettings.baseUrl.help': 'The URLs are produced from the BASE URL defined in the context file (es.: www.villanova.ai/ site/ en/ pagecode.page).  URLs are RELEATIVE when the URL omits the BASE URL (es.: /site /en / pagecode.page). BUILT BY HTTP REQUEST PARAMETERS when the URL is generated from the request parameter generated by the preview request. STATIC when the generated URL is inserted in the BASE URL defined by the context file ( es.: www.villanova.ai/ site/ en/ pagecode.page)',
    ...
    'dataModel.help': 'The DATA MODELS section allows the administrator to add or edit content data.  The Villanova formatting engine,  based on models, is used to present content (or a portion of it) to users. Content data use Velocity templates and  are easily managed from the administration Interface.',
    'dataModel.type': 'Type',
    ...
    'componentRepository.component.help': 'Villanova Hub is a repository from which users can install different widgets, components, fragments, page templates, content templates and content types.',
    ...
    'componentRepository.settings.help': 'In this section it is possible to setup and manage the settings of marketplaces within the Villanova Hub.',
    ...
    'info.license.description': 'The Villanova platform is 100% open source and as a whole is licensed under the LGPL v3.0. \n\nA free commercial open source license is available for Villanova platform and the Villanova Hub for customers with Gold and Platinum subscriptions.\nWith this license, you can freely extend or modify Villanova without requiring the contribution of confidential IP back to the open source community.\n\nThe Subscription entitles you to receive support services, intended as maintenance and warranty of the software (bug fixing), for all the products and components subscribed throughout the period of the contract.',
    'info.license.type': 'LGPL v3.0 license',
    'info.about': 'About',
    'info.about.entandoPlatform': 'Villanova Platform',
    'info.about.entando': 'Villanova is the leading open source Application Composition Platform for Kubernetes. It enables parallel teams to accelerate development and innovation of business capabilities on a modern, cloud-native, and Kubernetes-native stack.',
    'info.about.docs': 'The documentation helps you learn about the Villanova Platform and start exploring its features.\n To get started using the Villanova Platform, visit',
    ...
    'tour.start.welcome': 'Welcome to Villanova',
    ...
    'cms.contents.edit.titletip': 'The CONTENT section allows users to manage existing content, access content lists, and add new content. Users can also approve, suspend, or delete content. In Villanova, Content is a structured element that represents a set of information built using Content Attributes.',
    ...
    'cms.contents.tip': 'The Content section allows users to manage existing content, access content lists, and add new content. Users can also approve, suspend, or delete content. In Villanova, Content is a structured element that represents a set of information built using Content Attributes.',
