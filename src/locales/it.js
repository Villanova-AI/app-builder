export default {
  ...
  messages: {
    ...
    'app.welcome': 'Benvenuto in Villanova, {name}!',
    'app.yes': 'Si',
    'app.no': 'No',
    'app.add': 'Aggiungi',
    'app.edit': 'Modifica',
    ...
    'pages.pageForm.ownerGroupHelp': 'É necessario impostare il Gruppo Proprietario per definire le persone che hanno il permesso di vedere questa pagina. I Gruppi si creano e gestiscono nell\'area Settings di Villanova.',
    ...
    'pages.pageForm.mimeTypeHelp': 'Identifica il tipo di informazione (immagine, testo...) che Villanova deve restituire al browser che le richiede',
    ...
    'labelsAndLanguages.help': 'Dalla sezione ETICHETTE E LINGUE è possibile gestire le lingue e le etichette di sistema. Villanova supporta il multilingua, l\'amministratore può aggiungere una nuova lingua. La prima lingua configurata nel sistema è la lingua predefinita. Le etichette sono accessori di Villanova, usate principalmente per gestire semplici informazioni testuali semi-statiche, non associate ad oggetti particolari.',
    ...
    'componentRepository.component.list.title': 'Villanova Hub',
    'componentRepository.component.help': 'Villanova Hub è un marketplace da cui l\'utente può installare Widget, Componenti, UX Fragment, Template di Pagina, Modelli di Contenuto e Tipi di Contenuto',
    ...
    'componentRepository.settings.help': 'In questa sezione è possibile aggiungere o gestire le configurazioni di diversi marketplace all\'interno del Component Repository di Villanova.',
    ...
    'info.license.description': 'La piattaforma Villanova è open source al 100% e nel suo insieme è concessa in licenza con LGPL v3.0. \n\nUna licenza commerciale open source gratuita è disponibile per la piattaforma Villanova e l\'Hub Villanova per i clienti con abbonamenti Gold e Platinum.\nCon questa licenza, puoi estendere o modificare liberamente Villanova senza richiedere il contributo di IP riservato alla community open source.\n\nL\'Abbonamento dà diritto a ricevere servizi di supporto, intesi come manutenzione e garanzia del software (correzione di bug), per tutti i prodotti e componenti sottoscritti per tutta la durata del contratto.',
    'info.license.type': 'LGPL v3.0 licenza',
    'info.about': 'Informazioni',
    'info.about.entandoPlatform': 'Villanova Platform',
    'info.about.entando': 'Villanova è la principale Application Composition Platform open source per Kubernetes. Consente a team che lavorano in parallelo di accelerare lo sviluppo e l\'innovazione delle funzionalità aziendali su uno stack moderno, cloud-native e Kubernetes-native',
    'info.about.docs': 'La documentazione ti fa conoscere la piattaforma Villanova e ti guida nell\'esplorazione delle sue funzionalità. Per iniziare ad utilizzare la piattaforma Villanova, visita',
    ...
    'tour.start.welcome': 'Benvenuto in Villanova',
    ...
    'tour.step.2.title': 'Villanova AppBuilder',
